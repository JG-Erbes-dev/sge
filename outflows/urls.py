...
urlpatterns = [
    ...
    path('api/v1/outflows/', views.OutflowCreateListAPIView.as_view(), name='outflows_create_list_api_view'),
    path('api/v1/outflows/<int:pk>/', views.OutflowRetrieveAPIView.as_view(), name='outflows_detail_api_view'),
]
